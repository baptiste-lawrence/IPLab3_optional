...
void computercorner2(char board[3][3])
{
	int rd;
	space();
	srand( time(NULL) );
...
void intelligentcomputer(int count, char board[3][3])
{
	...
	for(;;)
	{
		...
		else if(count==1&&(board[1][1]=='X'&&(board[0][0]=='X'||board[0][2]=='X'||board[2][0]=='X'||board[2][2]=='X')))
		{
			computercorner2(board);
			break;
		}
		else if(a == 180 && d == 180 && board[1][0] == 'X' && board[0][1] == 'X')
		{
			space();
			board[0][0] = 'O';
			printBoard(board);
		...
		else if(a == 180 && f == 180 && board[1][0] == 'X' && board[2][1] == 'X')
		{
			space();
			board[2][0] = 'O';
			printBoard(board);
		...
		else if(c == 180 && d == 180 && board[0][1] == 'X' && board[1][2] == 'X')
		{
			space();
			board[0][2] = 'O';
			printBoard(board);
		...
		else if(c == 180 && f == 180 && board[1][2] == 'X' && board[2][1] == 'X')
		{
			space();
			board[2][2] = 'O';
			printBoard(board);
		...
		else if(a == 171 && d == 171 && board[1][0] == 'O' && board[0][1] == 'O')
		{
			space();
			board[0][0] = 'O';
			printBoard(board);
		...
		else if(a == 171 && f == 171 && board[1][0] == 'O' && board[2][1] == 'O')
		{
			space();
			board[2][0] = 'O';
			printBoard(board);
		...
		else if(c == 171 && d == 171 && board[0][1] == 'O' && board[1][2] == 'O')
		{
			space();
			board[0][2] = 'O';
			printBoard(board);
		...
		else if(c == 171 && f == 171 && board[1][2] == 'O' && board[2][1] == 'O')
		{
			space();
			board[2][2] = 'O';
			printBoard(board);
